...
export function SystemBrand(props: SystemBrandProps) {
  ...
  // InterAPI ships its own brand identity as a theme-level skin. When the
  // operator hasn't customized `system_name` in the DB, fall back to
  // "InterAPI" rather than the upstream project name.
  const name = status?.system_name || props.defaultName || 'InterAPI'
  const version =
